        ...
        <View style={styles.debugPanel}>
          ...
          <ScrollView style={styles.debugScrollView}>
            ...
            <View style={styles.debugSection}>
              ...
              <Text style={styles.debugText}>gymnast: {String(gymnastid)}</Text>
            </View>

{/* Responsive Info */}
            <View style={styles.debugSection}>
              <Text style={styles.debugSectionTitle}>Responsive Info:</Text>
              <Text style={styles.debugText}>isLargeDevice: {isLargeDevice ? "true" : "false"}</Text>
              <Text style={styles.debugText}>isSmallDevice: {isSmallDevice ? "true" : "false"}</Text>
              <Text style={styles.debugText}>isTinyDevice: {isTinyDevice ? "true" : "false"}</Text>
              <Text style={styles.debugText}>Width: {String(width)}</Text>
              <Text style={styles.debugText}>Height: {String(height)}</Text>
            </View>
            ...
            <View style={styles.debugSection}>
              ...
              <Text style={styles.debugText}>ID: {String(gymnastid)}</Text>
            ...
            {(vaultnumber || vaultDescription || startValue !== undefined || gender !== undefined) && (
              <View style={styles.debugSection}>
                ...
                {startValue !== undefined && <Text style={styles.debugText}>Start Value: {String(startValue)}</Text>}
            ...
            <View style={styles.debugSection}>
              ...
              <Text style={styles.debugText}>Rate ID: {String(rateid)}</Text>
              <Text style={styles.debugText}>Total Elements: {String(totalElements)}</Text>
              <Text style={styles.debugText}>Difficulty Values: {String(difficultyValues)}</Text>
              <Text style={styles.debugText}>Element Groups Total: {String(elementGroupsTotal)}</Text>
              <Text style={styles.debugText}>CV: {String(cv)}</Text>
              <Text style={styles.debugText}>SV: {String(sv)}</Text>
              <Text style={styles.debugText}>ND: {String(nd)}</Text>
            ...
            <View style={styles.debugSection}>
              ...
              <Text style={styles.debugText}>Execution: {String(execution)}</Text>
              <Text style={styles.debugText}>E-Score: {String(eScore)}</Text>
              <Text style={styles.debugText}>My Score: {String(myScore)}</Text>
              <Text style={styles.debugText}>Score: {String(score)}</Text>
              <Text style={styles.debugText}>Delta: {String(delt)}</Text>
              <Text style={styles.debugText}>Deduction: {String(ded)}</Text>
              <Text style={styles.debugText}>Percentage: {String(percentage)}</Text>
            </View>
            ...
            <View style={styles.debugSection}>
              ...
              {Object.entries(elementCounts).map(([key, value]) => (
                <Text key={key} style={styles.debugText}>
                  {key}: {String(value.value)} (Selected: {value.selected ? "Yes" : "No"})
                </Text>
              ))}
            </View>
            ...
            <View style={styles.debugSection}>
              <Text style={styles.debugSectionTitle}>Competition Info:</Text>
              <Text style={styles.debugText}>D: {String(d)}</Text>
              <Text style={styles.debugText}>E: {String(e)}</Text>
              <Text style={styles.debugText}>ND Comp: {String(ndcomp)}</Text>
            ...
            <View style={styles.debugSection}>
              ...
              <Text style={styles.debugText}>Save Attempts: {String(saveAttempts)}</Text>
