  ...
  const handleAddPhoto = useCallback(async () => {
    try {
      ...
      if (ok) {
        ...
        await loadPhotos(); await loadPhotoItems(); setActivePhoto(asset.uri);
      }
    } catch(e){ console.error('handleAddPhoto error', e); Alert.alert('Error','No se pudo añadir la imagen'); }
