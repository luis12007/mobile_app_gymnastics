  ...
  const finalTableHTML = `
    <div class="page final-table-page">
      ...
      <div class="statistics-section">
        ...
        <div class="stats-grid">
          <div class="stat-box">
            <div class="stat-number">${finalTableData.participants.length}</div>
            <div class="stat-label">Total Participants</div>
          </div>
          <div class="stat-box">
            <div class="stat-number">${Math.max(...finalTableData.participants.map(p => p.scores.myScorefinal)).toFixed(3)}</div>
            <div class="stat-label">Highest Score</div>
          </div>
          <div class="stat-box">
            <div class="stat-number">${(finalTableData.participants.reduce((sum, p) => sum + p.scores.myScorefinal, 0) / finalTableData.participants.length).toFixed(3)}</div>
            <div class="stat-label">Average Score</div>
          </div>
        </div>
      </div>
